...
awstgtfile="EmployeeSalaryRank.csv"
exptfile="EmployeeSalaryRank_exp.csv"
...
################################################
##Mapping Details##############################
MapName="EmployeeSalaryRank_map"
srcfile="$infuser/INPUT/EmployeeJ.json"
tgtfile="$infuser/OUTPUT/EmployeeSalaryRank.csv"
tgtopr="Insert"
tgtcodpg="UTF"
tgtfmt="FLAT"
MapTask="EmployeeSalaryRank_task"
TaskMapPath=$1
#####################################################
###Expression Details#################################
expr1="rank"
expr2="employeerank"
tgtfields="rankindex salary"
########################################################
...
valid_stages=("rank" "employeerank")
###############################################################################################
