...
awstgtfile="Emp#Sal.csv"
exptfile="Emp#Sal_exp.csv"
...
################################################
##Mapping Details##############################
MapName="DeptTotalSalary_map"
srcfile="$infuser/INPUT/Employee_Data.csv"
tgtfile="$infuser/OUTPUT/Emp#Sal.csv"
tgtopr="Insert"
tgtcodpg="UTF"
tgtfmt="FLAT"
MapTask="DeptTotalSalary_task"
TaskMapPath=$1
#####################################################
###Expression Details#################################
expr1="aggregator"
#expr2="manufactureryearlysales"
tgtfields="totalsalary empcount workdept"
########################################################
# Define the patterns to check
sal_expv="TotalSalary:SUM(TO_INTEGER(SALARY)"
sal_expr="EmpCount:COUNT(TO_INTEGER(EMPNO)"
#########################################################
# Initialize flags
