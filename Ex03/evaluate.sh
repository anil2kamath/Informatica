...
awstgtfile="ManufacturerSales.csv"
exptfile="ManufacturerSales_exp.csv"
...
################################################
##Mapping Details##############################
MapName="NormalizerAggregator_map"
srcfile="$infuser/INPUT/CarSales.json"
tgtfile="$infuser/OUTPUT/ManufacturerSales.csv"
tgtopr="Insert"
tgtcodpg="UTF"
tgtfmt="FLAT"
MapTask="NormalizerAggregator_task"
TaskMapPath=$1
#####################################################
###Expression Details#################################
expr1="normalizer"
expr2="manufactureryearlysales"
tgtfields="totalsales manufacturer"
########################################################
# Define the patterns to check
sal_expv="SUM(QuarterlySales)"
...
valid_stages=("normalizer" "manufactureryearlysales")
###############################################################################################
