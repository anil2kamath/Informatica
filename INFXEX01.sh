...
#################################################################
uname="salesforce-lab2@teknoturf.net"
passwd="Tek@12345"
infuser="USER01"
################################################################################################
...
AWS_ACCESS_KEY_ID=$aws_acckey AWS_SECRET_ACCESS_KEY=$aws_seckey aws s3 ls s3://$tgtbuck/$infuser/
extractfile=$(AWS_ACCESS_KEY_ID=$aws_acckey AWS_SECRET_ACCESS_KEY=$aws_seckey aws s3 cp s3://$tgtbuck/$infuser/$awstgtfile .)
